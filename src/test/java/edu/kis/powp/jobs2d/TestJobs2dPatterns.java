...
public class TestJobs2dPatterns {
	...
	private static void setupDrivers(Application application) {
		...
		Job2dDriver basicLineDriver = new LineDrawerAdapter(DrawerFeature.getDrawerController(), LineDrawerAdapter.LineMode.SOLID_LINE);
		DriverFeature.addDriver("Basic Line", basicLineDriver);

		Job2dDriver specialLineDriver = new LineDrawerAdapter(DrawerFeature.getDrawerController(), LineDrawerAdapter.LineMode.SPECIAL_LINE);
